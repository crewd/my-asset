...
function SearchPage() {
  return (
    <div>
      ...
      <div>
        <Box classname="flex justify-between first:rounded-t-xl mb-1.5 text-center text-xxs sm:text-xs font-normal">
        ...
        <Box classname="flex justify-between first:rounded-t-xl mb-1.5 text-center text-xxs sm:text-xs font-normal last:mb-0 ">
